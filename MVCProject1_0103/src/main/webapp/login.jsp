...
<table border=1>
<tr><td colspan=2><input type="checkbox" value="autoLogin" name="autoLogin">로그인 유지 | 
...
<span style="color:red">${idErr }</span></td>
	<td rowspan=2><input type="image" src="images/s_img1.jpg" width="50px" height="50px"/></td></tr>
<tr><td><input type="password" name="pw" placeholder = "비밀번호"/><br/>
<span style="color:red">${pwErr }</span></td></tr>
<tr><td colspan=2>아이디/비밀번호 찾기 | <a href="memberAgree.mem">회원가입</a></td></tr>
</table>
</form>
</body>
</html>