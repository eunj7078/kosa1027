...
import controller.member.MemberDscriptController;
import controller.member.MemberModifyController;
...
public class EmployeeFrontController extends HttpServlet implements Servlet{
	public void doProcess(HttpServletRequest request, 
		...
		if(command.equals("/employeeList.emp")) {
			...
			EmployeeUpdateController action = new EmployeeUpdateController();
			action.execute(request);
			response.sendRedirect("employeeInfo.emp?num="
