...
public class Ex15 {
	...
	public static void main(String[] args) {
		...
		String name = today.name(); 	//열거형 상수를 문다열로 형변환
		System.out.println(name);  		//문자열
		
		//열거형 상수가 가지고 있는 정수값을 가지고 오기
		
		int ordinal = today.ordinal(); //열거형 상수가 갖고 있는 상수
		...
		System.out.println(result); //목요일은 화요일로부터 2일 지났습니다.
		result = day2.compareTo(day1);
		System.out.println(result); //화요일은 2일 전입니다.
